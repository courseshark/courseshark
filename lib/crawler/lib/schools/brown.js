...
var brown = module.exports = everySchool.submodule('brown')
	...
	.saveSelf(function(){
		...
		fs.writeFileSync(__dirname + '/../../cache/brown.cache', JSON.stringify(cacheJSON))
		next()
	})
	...
	.loadSelf(function(){
		var fs = require('fs')
		cacheJSON = JSON.parse(fs.readFileSync(__dirname + '/../../cache/brown.cache').toString())
