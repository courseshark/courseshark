...
var wvu = module.exports = everySchool.submodule('wvu')
	...
	.saveSelf(function(){
		...
		fs.writeFileSync(__dirname + '/../../cache/wvu.cache', JSON.stringify(cacheJSON))
		next()
	})
	...
	.loadSelf(function(){
		var fs = require('fs')
		cacheJSON = JSON.parse(fs.readFileSync(__dirname + '/../../cache/wvu.cache').toString())
