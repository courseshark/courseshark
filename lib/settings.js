...
function bootApplication(app){
	...
	jsBrowserfiyBundle = browserify({debug:true})
	jsBrowserfiyBundle.addEntry(__dirname+'/../public/scripts/app.js')
	...
	app.configure(function(){
		...
		app.use(express.session({
			...
			store: new mongoStore({
				...
				username: app.config.db.auth.user,
				password: app.config.db.auth.pass,
				collection : 'sessions'
			}),
