(function(window){
	...
	var term = {}
		...
		,	array_diff = function(o,a){return o.filter(function(e){return((a.indexOf(e)>-1)===false)})}
...
***************************************************************************/
	Shark = function(){
		this.io = {seats: seats, notifications: notifications}
		this.Schedule = require('/scripts/modules/schedule')
		return this
	}
	window.shark = new Shark();
